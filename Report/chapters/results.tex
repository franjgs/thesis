...
As soon as a user visits the front page of the web interface, they are presented with a choice between the \emph{Ratings} and \emph{Monitoring} modules, as shown in Figure~\ref{landing}.
\begin{figure}
    \centering
...
\begin{figure}
    ...
    \label{monitoring_bagging_zoomed}
\end{figure}
