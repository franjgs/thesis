...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth,scale=0.5]{svm_non_linear_data.eps}
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth,scale=0.5]{svm_non_linear_classify_linear.eps}
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth,scale=0.5]{svm_non_linear_classify_rbf.eps}
